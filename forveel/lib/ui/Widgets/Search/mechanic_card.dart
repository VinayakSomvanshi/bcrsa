  ...
  Widget build(BuildContext context) {
    return ForveelTile(
      ...
      middle: <Widget>[
        ...
        Row(
          children: <Widget>[
            (widget.data['vehicle_type'].contains("tw"))
                ? Container(
                ...
                : Container(),
            (widget.data['vehicle_type'].contains("fw"))
                ? Container(
                    margin: EdgeInsets.only(right: 5),
                    child: Icon(
            ...
            Text(
              widget.data['name'],
              style: GoogleFonts.lato(fontWeight: FontWeight.w300, color: grey),
            ),
          ],
        ),
        Container(
        ...
        Container(
          ...
          child: Text(
            ...
            softWrap: false,
            maxLines: 2,
            style: GoogleFonts.lato(fontSize: 12, color: grey),
          ),
        ),
      ],
      ontap: () {
        Navigator.push(
            context,
            PageTransition(
                child: MechanicPageUID(widget.data.id, widget.data),
