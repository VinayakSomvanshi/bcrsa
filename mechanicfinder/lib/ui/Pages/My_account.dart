...
import 'package:mechanicfinder/Resources/ui/MechanicPageVidgets.dart';
...
class _MechanicPageUIDState extends State<MechanicPageUID> {
  late DocumentSnapshot _mechanic;
          ...
          child: ClipRRect(
            child: BackdropFilter(
              ...
              child: ListView(
                children: <Widget>[
                  Center(
                      child: VtypesShow(_mechanic['vehicle_type'],
                          _mechanic['Two wheeler'], _mechanic['Four wheeler'])),
                  SizedBox(
                    height: 15,
                  ),
                  ...
                  ExpansionTile(
                    ...
                    children:
                        List.generate(_mechanic['services'].length, (index) {
                      return ListTile(
                        onLongPress: () {},
                        title: Text(
                  ...
                  ListTile(
                    ...
                    trailing: Column(
                      children: <Widget>[
                        ...
                        Text(
                          (_mechanic['online']) ? "Available" : "Unavailable",
                          style: GoogleFonts.lato(color: background),
                        )
                      ],
                    ),
                  ...
                  ListTile(
                    ...
                    title: Text(
                      "${_mechanic['address']}",
                      style: GoogleFonts.lato(color: background, fontSize: 14),
                    ),
                  ),
                  SizedBox(
                    height: 15,
