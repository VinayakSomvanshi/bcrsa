...
import 'package:mechanicfinder/ui/Widget/Settings/Addbrands.dart';
...
class _VehicleSettingsState extends State<VehicleSettings> {
                ...
                if (_user['Two wheeler'].isNotEmpty) {
                  return Text(
                    ...
                    style: GoogleFonts.lato(
                        color: grey, fontSize: 10, fontWeight: FontWeight.w300),
                    overflow: TextOverflow.ellipsis,
                    maxLines: 1,
                  );
                }
                return Text(
                  "Set up vehicle brands",
                  style: GoogleFonts.lato(
                      color: grey, fontSize: 10, fontWeight: FontWeight.w300),
                );
              }(),
  ...
  _change(List<dynamic> list) async {
    ...
    await FirebaseFirestore.instance
        ...
        .update({'vehicle_type': list}).then((value) {
