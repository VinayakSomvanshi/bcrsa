...
class _RequestCardState extends State<RequestCard> {
  ...
  Widget build(BuildContext context) {
    if (widget.data == null || !widget.data.exists) {
      // No request data available, show a placeholder or a message.
      return Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        Text(
                          "Location",
                          style: TextStyle(fontSize: 10, color: voilet),
                        )
                      ],
                    ),
                  ),
